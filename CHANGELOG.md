...
### 修复
- 工具栏背景色与标题栏一致（深色模式RGB 42,42,43，浅色模式RGB 231,231,232）
- 去掉标题栏和工具栏之间的黑色边框分割线
- 使用WindowConfigurator设置窗口属性
- 添加screenshots目录到.gitignore

## [0.2.8] - 2026-05-12

### 修复
- 标题栏现在正确显示NavicatMac
- 版本号显示为Version 0.2.7（无括号）
- 使用WindowTitleView设置窗口标题
- 创建自定义AboutView只显示版本号
- 移除TabView避免覆盖窗口标题
...
- 标题栏现在显示NavicatMac
- 版本号更新为0.2.5 (25)
- 使用NSApplication.shared.windows设置窗口标题
